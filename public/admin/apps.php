...
// Overzicht van eigen webapps. Voorlopig één.
$apps = [
    [
        'title'       => 'Game Backlog',
        'description' => 'Een persoonlijke game-management app waarmee ik mijn games kan organiseren.',
        'tech'        => ['PHP', 'MySQL', 'JavaScript'],
        'url'         => './apps/game-backlog.php',
    ],
];
?>
<!doctype html>
...
<head>
    ...
    <title>Apps — Portfolio Admin</title>
...
<header class="topbar">
    ...
    <h1 class="topbar__title">Apps</h1>
...
<main class="main">
    <section class="section">
        <h2>Apps</h2>
        <p style="margin:0 0 16px; color:var(--muted)">Een overzicht van mijn eigen webapps en experimenten.</p>

        <div class="grid two">
            <?php foreach ($apps as $app): ?>
                <article class="card">
                    <header class="card__header">
                        <h3 style="margin:0"><?= e($app['title']) ?></h3>
                    </header>
                    <div class="card__body">
                        <p style="margin:0 0 14px"><?= e($app['description']) ?></p>

                        <div class="actions" style="margin-bottom:16px">
                            <?php foreach ($app['tech'] as $tech): ?>
                                <span class="pill"><?= e($tech) ?></span>
                            <?php endforeach; ?>
                        </div>

                        <div class="actions">
                            <a class="btn btn-primary" href="<?= e($app['url']) ?>">Open App</a>
                        </div>
                    </div>
                </article>
            <?php endforeach; ?>
